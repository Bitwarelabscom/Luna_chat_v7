...
git clone <your-git-host>/luna_chat_v7.git luna-chat
git clone <your-git-host>/memorycore.git memorycore
git clone <your-git-host>/neuralsleep.git neuralsleep
