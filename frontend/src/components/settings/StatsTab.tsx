...
function StatCard({
  ...
  const colorClasses = {
    luna: 'bg-luna-500/10 text-luna-400',
    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        {Object.keys(stats.tokens.byModel).length > 0 && (
          <div className="mt-4 p-4 bg-gray-800/50 rounded-lg border border-gray-700">
            <h5 className="text-sm font-medium text-gray-400 mb-3">Tokens by Model</h5>
      ...
      <div>
        ...
        {Object.keys(stats.memory.factsByCategory).length > 0 && (
          <div className="mt-4 p-4 bg-gray-800/50 rounded-lg border border-gray-700">
            <h5 className="text-sm font-medium text-gray-400 mb-3">Facts by Category</h5>
